...
This tab provides users with data exploration tools to explore on network association amongst the top actors (with more than 300 interactions in each year) involved in the armed conflict incidents in Myanmar. Figure below shows the UI interactive features in the **Network Relationships** sub-tab.
