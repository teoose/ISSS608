...
To visualise the network, the team will calculate the following measures: Number of Components (Communities) and Cliques in the network.

-   Degree and Weighted Degree Centrality of each group.

-   Betweenness Centrality of each group.

-   Eigenvector Centrality of each group.

-   Clustering Coefficient of each group.
