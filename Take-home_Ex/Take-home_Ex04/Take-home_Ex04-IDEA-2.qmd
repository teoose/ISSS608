...
-   Clustering & Outlier Analysis/ Hot & Cold Zone Analysis
...
3.  Prototype: Exploratory – [Click here for Prototype: Exploratory page](https://isss608-ay2024-suanern.netlify.app/take-home_ex/take-home_ex04/take-home_ex04-Prototype-2.html){target="_blank"}.
...
-   The prototype proposes to include the following interactivity elements for users' data exploratory:
    ...
    -   Radio button selection on *event_type* or *admin1*
    -   Radio button selection on frequency method (for jitter points) based on either kernel density distribution or count distribution
...
box1 <- ggplot(dist, aes(x = forcats::fct_infreq(admin1), y = event_date, 
                          color = factor(admin1))) +
...
#| code-fold: true 
#| code-summary: "Show code"
box2 <- ggplot(dist, aes(x = forcats::fct_infreq(event_type), y = event_date, 
...
-   The prototype proposes to include the following interactivity elements for users' data exploratory:
    -   Dropdown filters by *year*
    -   Radio button selection on the *armed conflicts* or *fatalities*
...
### Trend line of armed conflicts and fatalities in Myanmar
...
-   The prototype proposes to include the following interactivity elements for users' data exploratory:
    ...
    -   Dropdown filters by year. This allows quick visual summary on the keywords used in all armed conflict incidents of each year.
:::
...
There are multiple actors (over 1,000 unique groups, with new groups formed and some groups renamed themselves over the years) that have created conflicts in Myanmar. The team hopes to make use of a network graph to schematically depict the nodes and connections amongst the different actors and their associations, and to identify the top actors based on their interactions in each year.

-   The *nodes* of the network represent the groups (actors and associate actors).

-   The *edges* of the network represent whether the two nodes are interconnected or not.
...
-   The prototype proposes to include the following interactivity elements for users' data exploratory:
    -   Selection options to select by *event_type* and *admin1*
    -   Dropdown filters by year. This allows quick visual summary of the network association of the actors in each year.
    -   Slider bar to select frequency of actors' network association with each other.
:::
...
**Geospatial Exploratory Data Analysis** can be found via [link here](https://isss608-ay2024-suanern.netlify.app/take-home_ex/take-home_ex04/take-home_ex04-GDEA-2.html){target="_blank"}.
...
**Prototype: Exploratory** can be found via [link here](https://isss608-ay2024-suanern.netlify.app/take-home_ex/take-home_ex04/take-home_ex04-Prototype-2.html){target="_blank"}.
